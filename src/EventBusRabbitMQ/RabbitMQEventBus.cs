...
{
    private const string ExchangeName = "cats_event_bus";
    ...
    private readonly ushort _prefetchCount = options.Value.PrefetchCount;
    ...
    private async Task ProcessEvent(string eventName, string message)
    {
        ...
        {
            throw new InvalidOperationException($"Unable to deserialize event type {eventType}");
        }
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        _ = Task.Factory.StartNew(async () =>
        {
            try
            {
                ...
                await _consumerChannel.BasicQosAsync(prefetchSize: 0, prefetchCount: _prefetchCount, global: false, cancellationToken: cancellationToken);
