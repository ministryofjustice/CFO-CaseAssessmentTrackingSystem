...
public static class CatsIcons
{
    ...
    public const string Housing = "<g><rect fill=\"none\" height=\"24\" width=\"24\"/></g><g><path Md=\"19,9.3V4h-3v2.6L12,3L2,12h3v8h5v-6h4v6h5v-8h3L19,9.3z M10,10c0-1.1,0.9-2,2-2s2,0.9,2,2H10z\"/></g>";
