...
public class ActivityQa1QueueEntityTypeConfiguration : IEntityTypeConfiguration<ActivityQa1QueueEntry>
{
    public void Configure(EntityTypeBuilder<ActivityQa1QueueEntry> builder)
    {
        builder.ToTable(DatabaseConstants.Tables.ActivityQa1Queue, DatabaseConstants.Schemas.Activities);
