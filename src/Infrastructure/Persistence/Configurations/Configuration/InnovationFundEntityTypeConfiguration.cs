...
public class InnovationFundEntityTypeConfiguration : IEntityTypeConfiguration<InnovationFund>
{
    public void Configure(EntityTypeBuilder<InnovationFund> builder)
    {
        builder.ToTable(
            DatabaseConstants.Tables.InnovationFund,
        ...
        builder.Property(f => f.Code)
            .IsRequired()
            .HasMaxLength(DatabaseConstants.FieldLengths.InnovationFundCode);
        ...
        builder.Property(f => f.Description)
            .IsRequired()
            .HasMaxLength(DatabaseConstants.FieldLengths.InnovationFundDescription);
