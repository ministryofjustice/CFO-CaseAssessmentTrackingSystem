...
public class ProviderFeedbackActivityEntityTypeConfiguration : IEntityTypeConfiguration<ProviderFeedbackActivity>
{
    public void Configure(EntityTypeBuilder<ProviderFeedbackActivity> builder)
    {
        builder.ToTable(nameof(ProviderFeedbackActivity), DatabaseConstants.Schemas.Mi);
