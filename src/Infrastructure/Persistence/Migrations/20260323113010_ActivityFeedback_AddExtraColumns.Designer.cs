...
namespace Cfo.Cats.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260323113010_ActivityFeedback_AddExtraColumns")]
    partial class ActivityFeedback_AddExtraColumns
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cfo.Cats.Domain.Entities.Activities.ActivityFeedback", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("ActivityFeedbackReason")
                        .IsRequired()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)");
                    ...
                    b.Property<DateTime>("ActivityProcessedDate")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ActivityId", "Created");

                    b.HasIndex("RecipientUserId", "IsRead");

                    b.ToTable("ActivityFeedback", "Activities");
                });
            ...
            modelBuilder.Entity("Cfo.Cats.Domain.ParticipantLabels.ParticipantLabel", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Cfo.Cats.Domain.Entities.Activities.ActivityFeedback", b =>
                {
                    ...
                    b.HasOne("Cfo.Cats.Domain.Identity.ApplicationUser", "RecipientUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Cfo.Cats.Domain.Entities.Participants.PathwayPlanReview", b =>
                {
                    b.HasOne("Cfo.Cats.Domain.Entities.Participants.PathwayPlan", "PathwayPlan")
                        .WithMany("PathwayPlanReviews")
                        .HasForeignKey("PathwayPlanId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PathwayPlan");
                });
            ...
            modelBuilder.Entity("Cfo.Cats.Domain.ParticipantLabels.ParticipantLabel", b =>
                {
                    b.HasOne("Cfo.Cats.Domain.Labels.Label", "Label")
                        .WithMany()
                    ...
                    b.OwnsOne("Cfo.Cats.Domain.ValueObjects.Lifetime", "Lifetime", b1 =>
                        {
                            b1.Property<Guid>("ParticipantLabelId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("ParticipantLabelId");

                            b1.ToTable("Label", "Participant");

                            b1.WithOwner()
                                .HasForeignKey("ParticipantLabelId");
                        });
