...
public static class DescriptionAttributeExtensions
{
    public static string GetDescription(this Enum e)
    {
        ...
        var descriptionAttributes = memberInfo.GetCustomAttributes(
    ...
    public static string GetMemberDescription<T, TProperty>(
        this T t,
    ...
    public static string GetClassDescription<T>(this T t)
        where T : class
    {
        if (t is null)
        {
        ...
        var descriptionAttributes = t.GetType()
