...
{
    public class ParticipantEnrolmentAcceptedIntegrationEventHandler(IManagementInformationDbContext miContext, IApplicationDbContext applicationDbContext) : IConsumer<ParticipantTransitionedIntegrationEvent>
    {
