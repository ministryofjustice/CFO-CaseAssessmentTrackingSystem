...
[Description("Soon To Be Released Participants")]
public class SoonToBeReleasedPaginationDto
{
    [Description("PRI Id")]
    ...
    private class Mapping : Profile
    {
        public Mapping()
        {
            CreateMap<Domain.Entities.PRIs.PRI, SoonToBeReleasedPaginationDto>()
