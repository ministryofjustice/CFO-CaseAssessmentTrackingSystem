...
public static class ExportInductionPaymentsSummary
{
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument
                .Create(DocumentTemplate.InductionPaymentsSummary, "InductionPaymentsSummary.xlsx", "Inductions By Contract Summary Export", currentUser.UserId!, currentUser.TenantId!, json);
