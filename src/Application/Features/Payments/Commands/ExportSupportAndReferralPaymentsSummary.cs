...
public static class ExportSupportAndReferralPaymentsSummary
{
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument
                .Create(DocumentTemplate.SupportAndReferralPaymentsSummary, "SupportAndReferralPaymentsSummary.xlsx", "Support and Referral By Contract Summary Export", currentUser.UserId!, currentUser.TenantId!, json);
