...
public static class ExportActivityPaymentsSummary
{
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument
                .Create(DocumentTemplate.ActivityPaymentsSummary, "ActivityPaymentsSummary.xlsx", "Activities By Contract Summary Export", currentUser.UserId!, currentUser.TenantId!, json);
