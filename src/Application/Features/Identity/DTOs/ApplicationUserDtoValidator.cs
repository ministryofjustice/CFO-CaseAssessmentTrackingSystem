...
public class ApplicationUserDtoValidator : AbstractValidator<ApplicationUserDto>
{
        ...
        ITenantService tenantsService)
    {
        ...
        RuleFor(x => x.MemorablePlace)
            ...
            .Matches(ValidationConstants.LettersSpacesCommaApostorphe).WithMessage(_localizer[string.Format(ValidationConstants.LettersSpacesCommaApostorpheMessage, "Memorable place")]);
