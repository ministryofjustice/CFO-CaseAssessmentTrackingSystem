...
public sealed class MyTeamsParticipantsWithNoRiskResultsAdvancedSpecification : Specification<Participant>
{
    public MyTeamsParticipantsWithNoRiskResultsAdvancedSpecification(MyTeamsParticipantsWithNoRiskResultsAdvancedFilter filter)
    {
