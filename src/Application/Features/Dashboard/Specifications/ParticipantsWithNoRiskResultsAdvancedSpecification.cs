...
public sealed class ParticipantsWithNoRiskResultsAdvancedSpecification : Specification<Participant>
{
    public ParticipantsWithNoRiskResultsAdvancedSpecification(ParticipantsWithNoRiskResultsAdvancedFilter filter)
    {
