...
public static class ExportEducationAndTrainingDashboard
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required EducationAndTrainingDashboardExportRequest Request { get; init; }
    }
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.EducationAndTrainingDashboard,
                "EducationAndTrainingDashboard.xlsx",
                "Education & Training Dashboard Export",
                currentUser.UserId!,
    ...
    public class EducationAndTrainingDashboardExportRequest
    {
