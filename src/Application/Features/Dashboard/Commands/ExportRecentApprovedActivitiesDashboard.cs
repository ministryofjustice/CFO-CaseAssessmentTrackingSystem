...
public static class ExportRecentApprovedActivitiesDashboard
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required RecentApprovedActivitiesDashboardExportRequest Request { get; init; }
    }
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.RecentApprovedActivitiesDashboard,
                "RecentApprovedActivitiesDashboard.xlsx",
                "Recent Approved Activities Dashboard Export",
                currentUser.UserId!,
    ...
    public class RecentApprovedActivitiesDashboardExportRequest
    {
