...
public static class ExportReassessmentsDashboard
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required ReassessmentsDashboardExportRequest Request { get; init; }
    }
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.ReassessmentsDashboard,
                "ReassessmentsDashboard.xlsx",
                "Reassessments Dashboard Export",
                currentUser.UserId!,
    ...
    public class ReassessmentsDashboardExportRequest
    {
