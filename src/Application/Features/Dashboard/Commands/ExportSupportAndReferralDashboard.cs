...
public static class ExportSupportAndReferralDashboard
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required SupportAndReferralDashboardExportRequest Request { get; init; }
    }
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.SupportAndReferralDashboard,
                "SupportAndReferralDashboard.xlsx",
                "Support & Referral Dashboard Export",
                currentUser.UserId!,
    ...
    public class SupportAndReferralDashboardExportRequest
    {
