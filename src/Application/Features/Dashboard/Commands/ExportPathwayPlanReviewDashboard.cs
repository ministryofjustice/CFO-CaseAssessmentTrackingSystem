...
public static class ExportPathwayPlanReviewDashboard
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required PathwayPlanReviewDashboardExportRequest Request { get; init; }
    }
        ...
        ICurrentUserService currentUser) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.PathwayPlanReviewDashboard,
                "PathwayPlanReviewDashboard.xlsx",
                "Pathway Plan Review Dashboard Export",
                currentUser.UserId!,
    ...
    public class PathwayPlanReviewDashboardExportRequest
    {
