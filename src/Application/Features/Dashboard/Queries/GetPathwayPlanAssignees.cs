...
/// <summary>
/// Scopes the user picker on the Pathway Plan Reviews dashboard to support workers who own a
/// (non-archived) participant with a pathway plan, mirroring <see cref="GetPathwayPlans"/>.
/// </summary>
public static class GetPathwayPlanAssignees
{
