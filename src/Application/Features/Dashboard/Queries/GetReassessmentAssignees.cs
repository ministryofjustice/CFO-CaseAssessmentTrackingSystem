...
/// <summary>
/// Scopes the user picker on the Performance / Reassessments tab to support workers who have an
/// eligible reassessment payment in the tenant scope, mirroring <see cref="GetReassessments"/>.
/// </summary>
public static class GetReassessmentAssignees
{
