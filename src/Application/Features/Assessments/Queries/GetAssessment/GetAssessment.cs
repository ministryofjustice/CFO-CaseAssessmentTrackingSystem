...
public static class GetAssessment
{
    ...
    public class Query : ICacheableRequest<Result<AssessmentDto>>
    {
    ...
    internal class Handler : IRequestHandler<Query, Result<AssessmentDto>>
    {

        public async Task<Result<AssessmentDto>> Handle(Query request, CancellationToken cancellationToken)
        {
