...
public static class ExportEducationAndTraining
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required EducationAndTrainingExportRequest Request { get; init; }
    }
        ...
        ITenantService tenantService) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var filename = ExportDocumentNaming.BuildFileName("PerformanceEducationAndTraining");
            ...
            var description = ExportDocumentNaming.BuildDescription(
                "Performance Education & Training Export",
                ("Tenant", tenantName),
                ("User", userName),
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.PerformanceEducationAndTraining,
                filename,
                description,
                currentUser.UserId!,
    ...
    public class EducationAndTrainingExportRequest
    {
