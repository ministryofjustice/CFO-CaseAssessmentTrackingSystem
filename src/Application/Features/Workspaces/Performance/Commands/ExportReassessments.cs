...
public static class ExportReassessments
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required ReassessmentsExportRequest Request { get; init; }
    }
        ...
        ITenantService tenantService) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var filename = ExportDocumentNaming.BuildFileName("PerformanceReassessments");
            ...
            var description = ExportDocumentNaming.BuildDescription(
                "Performance Reassessments Export",
                ("Tenant", tenantName),
                ("User", userName),
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.PerformanceReassessments,
                filename,
                description,
                currentUser.UserId!,
    ...
    public class ReassessmentsExportRequest
    {
