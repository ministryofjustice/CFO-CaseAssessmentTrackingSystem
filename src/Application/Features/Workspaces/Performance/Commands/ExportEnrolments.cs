...
public static class ExportEnrolments
{
    [RequestAuthorize(Policy = SecurityPolicies.AuthorizedUser)]
    public class Command : ICommand<Result>
    {
        public required EnrolmentsExportRequest Request { get; init; }
    }
        ...
        ITenantService tenantService) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var filename = ExportDocumentNaming.BuildFileName("PerformanceEnrolments");
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.PerformanceEnrolments,
                filename,
                description,
                currentUser.UserId!,
    ...
    public class EnrolmentsExportRequest
    {
