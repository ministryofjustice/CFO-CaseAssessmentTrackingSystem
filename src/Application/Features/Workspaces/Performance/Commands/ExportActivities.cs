...
public static class ExportActivities
{
    ...
    {
        public required ActivitiesExportRequest Request { get; init; }
    }
        ...
        ITenantService tenantService) : ICommandHandler<Command, Result>
    {
        public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
        {
            ...
            var filename = ExportDocumentNaming.BuildFileName("PerformanceActivities");
            ...
            var document = GeneratedDocument.Create(
                DocumentTemplate.PerformanceActivities,
                filename,
                description,
                currentUser.UserId!,
