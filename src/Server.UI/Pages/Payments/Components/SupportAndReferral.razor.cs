...
public partial class SupportAndReferral
{
    ...
    private bool FilterFunc1(SupportAndReferralPaymentDto data) => FilterFunc(data, _searchString);

    private bool FilterFunc(SupportAndReferralPaymentDto data, string searchString)
    {
