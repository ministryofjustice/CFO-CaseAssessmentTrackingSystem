...
public partial class MyParticipantsInLicenceEndPeriod
{
    ...
    protected override IQuery<Result<PaginatedData<ParticipantsInLicenceEndPeriodResultsSummaryDto>>> CreateQuery()
