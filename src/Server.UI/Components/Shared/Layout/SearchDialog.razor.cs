    ...
    protected override void OnInitialized()
    {
        ...
        if (UserProfile is not null)
        {
            ...
            if (UserProfile.AssignedRoles.Any(r => allowed.Contains(r)))
            {
                ...
                _pages.Add("Quality Assurance", "/pages/dashboard/qualityassurance");
            }

            allowed = [RoleNames.QAManager, RoleNames.SMT, RoleNames.SystemSupport];
            if (UserProfile.AssignedRoles.Any(r => allowed.Contains(r)))
            {
                _pages.Add("Queue Management", "/pages/qa/servicedesk/enrolments");
            }
            ...
            if (UserProfile.AssignedRoles.Any(r => allowed.Contains(r)))
            {
                _pages.Add("Activities Queue Management", "/pages/qa/activities/activities");
            }
