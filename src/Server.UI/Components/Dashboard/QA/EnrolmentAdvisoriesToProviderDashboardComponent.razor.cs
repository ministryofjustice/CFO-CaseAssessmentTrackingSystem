...
public partial class EnrolmentAdvisoriesToProviderDashboardComponent
{ 
    ...
    private ApexCharts.ApexChartOptions<GetEnrolmentAdvisoriesToProvider.EnrolmentAdvisoriesChartData> Options => new()
    {
