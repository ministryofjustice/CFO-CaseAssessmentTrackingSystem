...
public partial class ActivitiesToProviderDashboardComponent
{ 
    ...
    private ApexCharts.ApexChartOptions<GetActivitiesToProvider.ActivitiesChartData> Options => new()
    {
