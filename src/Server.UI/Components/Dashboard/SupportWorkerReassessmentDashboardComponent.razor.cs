...
public partial class SupportWorkerReassessmentDashboardComponent
{
    ...
    protected override IRequest<Result<GetReassessmentsPerSupportWorker.ReassessmentsPerSupportWorkerDto>> CreateQuery()
     => new GetReassessmentsPerSupportWorker.Query()
     {
    ...
    private ApexCharts.ApexChartOptions<GetReassessmentsPerSupportWorker.Details> Options => new()
    {
