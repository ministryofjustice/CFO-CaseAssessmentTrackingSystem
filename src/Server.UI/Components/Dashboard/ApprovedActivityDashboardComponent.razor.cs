...
public partial class ApprovedActivityDashboardComponent
{
    ...
    protected override IRequest<Result<GetApprovedActivities.ApprovedActivitiesDto>> CreateQuery()
     => new GetApprovedActivities.Query()
     {
