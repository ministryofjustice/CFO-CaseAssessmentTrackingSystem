...
public partial class CommencedActivityDashboardComponent
{
    ...
    protected override IRequest<Result<GetCommencedActivities.CommencedActivitiesDto>> CreateQuery()
     => new GetCommencedActivities.Query()
     {
