...
public partial class SupportWorkerInductionDashboardComponent
{
    ...
    protected override IRequest<Result<GetInductionsPerSupportWorker.InductionsPerSupportWorkerDto>> CreateQuery()
     => new GetInductionsPerSupportWorker.Query()
     {
    ...
    private ApexCharts.ApexChartOptions<GetInductionsPerSupportWorker.LocationDetail> Options => new()
    {
