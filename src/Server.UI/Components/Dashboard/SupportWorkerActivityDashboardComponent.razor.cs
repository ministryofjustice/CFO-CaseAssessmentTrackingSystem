...
public partial class SupportWorkerActivityDashboardComponent
{
    ...
    protected override IRequest<Result<GetActivitiesPerSupportWorker.ActivitiesPerSupportWorkerDto>> CreateQuery()
     => new GetActivitiesPerSupportWorker.Query()
     {
    ...
    private ApexCharts.ApexChartOptions<GetActivitiesPerSupportWorker.LocationDetail> Options => new()
    {
